...
export const fillColorFace = (c: IV3) => [...c, ...c, ...c, ...c, ...c, ...c]
export const fillColor6 = (c: IV3) => [...c, ...c, ...c, ...c, ...c, ...c]
export const getAngle = (x: number, y: number) => {
    let inRads = Math.atan2(y, x);
    return inRads - Math.PI / 2
}

export const angleFromCoords = (x: number, y: number) => {
...
export const createFaceWithSquare = (
    ...
    const v1_i: IV3 = [x1, y1, v1[2]]
    const v2_i: IV3 = [x2, y1, v1[2]]
    const v3_i: IV3 = [x2, y2, v1[2]]
    const v4_i: IV3 = [x1, y2, v1[2]]
...
export const rotateArr = (arr: number[], angle: number) => {
...
export const rotateArrY = (arr: number[], angle: number) => {
    const matrix = m4.yRotation(angle);
...
export const rotateArrZ = (arr: number[], angle: number) => {
...
export const scaleArr = (arr: number[], sX: number, sY: number, sZ: number) => {
...
export const inverseVertexOrder = (copyV: number[]) => {
